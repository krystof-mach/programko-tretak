<?php
/**
 * Unified Setup Script for programko-tretak
 * This file consolidates all database initialization, table creation, and system configuration.
 */
...
// 4. Migrations / Column Checks (from fix_storage.php)
echo "<h4>Running Migrations...</h4>";

// Check storage_limit in users
...
// Check file_size in cloud_files
...
// 5. System Configuration (from setup_cloud.php)
...
// 6. Fix Roles (from fix_roles.php)
// This only applies if these users exist
...
// 7. Hash existing passwords (from hash_passwords.php)
...
// 8. Populate Sample Data (from populate_data.php)
